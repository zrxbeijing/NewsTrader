...
class CCnewsDatabase:
    ...
    def __init__(self, date_string, only_allowed_domains, allowed_domains, dir_path='.'):
        """
    ...
    def query_aws_s3(self):
        ...
        try:
            ...
            query_results = [self.__CC_BASE_URL + result.split(' ')[-1] for result in query_results]
